...
const PUZZLE = {
  ...
  text: {
    ...
    welcomeInstructions: [
      "Look for 16 hidden words printed on wooden squares around the museum.",
      "Enter each word into the app to build the connections wall (please don't move the physical squares).",
      "Sort the words into four connected groups of four.",
      "You can start to solve the wall once you have found any four words or more.",
